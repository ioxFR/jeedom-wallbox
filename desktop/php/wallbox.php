					...
					<fieldset>
						<div class="col-lg-7">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="chargerid" placeholder="ID du chargeur"/>
								</div>
							</div>
...
<?php include_file('desktop', 'wallbox', 'js', 'wallbox');?>
